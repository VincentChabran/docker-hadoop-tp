...
features_df = immatriculation_df.select("immatriculation", "marque", "modele", "puissance", "longueur", "nbPlaces", "nbPortes", "couleur", "occasion", "prix")

# Étape 1 : Préparation des données - Cellule 2
# Assembler les caractéristiques dans un vecteur de caractéristiques
assembler = VectorAssembler(inputCols=["puissance", "longueur", "nbPlaces", "nbPortes", "prix"], outputCol="features", handleInvalid="skip")
...
result_df = clustered_df.select("immatriculation", "marque", "modele", "puissance", "longueur", "nbPlaces", "nbPortes", "couleur", "occasion", "prix", "category")
result_df.show(10)
...
# Assembler les caractéristiques dans un vecteur de caractéristiques
client_assembler = VectorAssembler(inputCols=["puissance", "longueur", "nbplaces", "nbportes", "prix"], outputCol="features", handleInvalid="skip")
